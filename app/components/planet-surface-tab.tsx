...
import { StyleSheet, View, ScrollView, Pressable, Linking, Image } from 'react-native'
...
export default function PlanetSurfaceTab({ planet } : {planet: PlanetType}) {
    const { name, surface, radius, revolutionTime, rotationTime, wikiLink, avgTemp, surfaceImage } = planet;
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: color.black }}>
            <View
                ...
                <Image 
                    resizeMode="contain" 
                    style={{ height: 100, width: 100, position: 'absolute', bottom: 0, alignSelf: 'center', }} 
                    source={surfaceImage} 
                />
            </View>
